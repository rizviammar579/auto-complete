...
const AssignmentTable = ({ assignments, activeAssignment, setActiveAssignment, show, setShow }) => {
  return (
    <div className="w-full max-h-[70vh] bx:rounded-2xl overflow-x-auto overflow-y-auto">
          ...
          <tbody>
            {assignments.map((assignment) => (
              <tr
                ...
                className={`${activeAssignment === assignment
                  ? 'border-gray-200 rounded-full border-l-[#2563EB] bg-[#E8F1FF] border-l-[4px]'
              ...
              >
                ...
                <td className="px-6 py-4 font-semibold flex items-center justify-center">
                  <a
                    ...
                    href={assignment.assignment.alternateLink}
                    className="border p-1.5 text-gray-300 rounded-xl"
                  >
                    <img
                      src="../../googleclassroom.png"
