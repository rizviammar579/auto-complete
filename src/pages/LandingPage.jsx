      ...
      <div className='flex bg-gray-50 rounded-xl h-[82.5vh]'>
        ...
        <div className='w-[50vw] flex flex-col items-center gap-30'>
          ...
          <div className='flex flex-col gap-5'>
            <button className='flex gap-3 justify-center items-center cursor-pointer border border-gray-400 p-3 rounded-xl hover:rounded-full bg-white transition-all' onClick={()=>{window.location.href="http://localhost:3000/auth/google"}}>
